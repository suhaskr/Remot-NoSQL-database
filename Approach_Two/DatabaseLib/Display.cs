 ...
 * Public Interface:
 * -----------------
 *  makeMargin(string) - Used to add 2 blank spaces to the beginning of lines
 *  
 *  makeLinear(string) - Used to replace newline with ", "
 *
 *  formatElement(string, bool) - Used to format db elements
 *
 *  showElement(string) - Used to display db elements
 *
 *  showDB(this db) - Used to display contents of database
 *
 *  showEnumerableDB - Used to display enumerable contents of database
 *
 * Package Operations:
 * -------------------
 ...
 * --------------------
 * ver 1.3 : 9 Oct 15
 * - changed name space, added comments and public interface
 * ver 1.2 : 24 Sep 15
