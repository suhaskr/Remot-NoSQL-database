 ...
 * Public Interface:
 * -----------------
 *  showMetaData<Key, Data> - Used to write metadata to string.
 *
 *  showElement<Key, Data> - Write details of element with simple Data to string. 
 *
 *  showElement<Key, Data, T> - Write details of element with enumerable Data to string.
 *
 *  show<Key, Value, Data> -  Write simple db elements out to Console.
 * 
 *  show<Key, Value, Data, T> -  Write enumerable db elements out to Console.
 *
 * Package Operations:
 * -------------------
 ...
 * ver 1.3 : 9 Oct
 * - changed namespace
 * - added comments and public interface
 * ver 1.2 : 24 Sep 15
...
namespace Project4Starter
{
  ...
  class TestDBExtensions
  {
    static void Main(string[] args)
    {
      ...
      elem1.children = new List<int> { 1, 2, 3, 4 };
